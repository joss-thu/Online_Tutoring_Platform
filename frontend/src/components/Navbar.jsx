          ...
          {menuItems.map((item) => (
            <button
              ...
              className={`px-4 py-2 text-sm font-merriweather_sans ${
                props.currentPage === item.path ? "bg-gray-200 rounded-md" : ""
              }`}
            >
              {item.label}
            </button>
        ...
        <div className="flex items-center px-4">
          {props.isLoggedIn ? (
            ...
            <div className="flex space-x-2">
              <button className="bg-black text-sm border-dark border rounded-full inline-flex items-center justify-center py-2 px-4 text-center font-merriweather_sans text-white">
                Log In
              </button>
