...
public class SearchCategoryTest {
    ...
    void testSearchTutorsAndCourses() {
        ...
        when(searchService.searchCourses("Java")).thenReturn(Collections.singletonList(mockCourse));

        // Call the search method
        List<Object> results = searchController.search("John", "Java");
        ...
        verify(searchService, times(1)).searchCourses("Java");
    }

    @Test
    void testSearchEmptyParameters() {
        // Call the search method with empty parameters
        List<Object> results = searchController.search(null, null);
