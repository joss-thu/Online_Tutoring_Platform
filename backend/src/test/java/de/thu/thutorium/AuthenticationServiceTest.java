...
////
////            when(roleRepository.findByRoleName(registerRequestTO.role())).thenReturn(role);
...
////
////            verify(roleRepository, times(1)).findByRoleName(registerRequestTO.role());
