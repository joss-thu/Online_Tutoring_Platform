 ...
 * {@link CourseDTO} (data transfer object) for use in the application.
 */
@Service
...
public class CourseServiceImpl implements CourseService {
   ...
   * and maps it to a {@link CourseDTO} object using the {@link CourseMapper}. If no course is found
   * for the provided ID, it returns {@code null}.
   *
   * @param id the unique ID of the course to retrieve.
   * @return a {@link CourseDTO} representing the course with the given ID, or {@code null} if no
   ...
   * CourseDTO} objects using the {@link CourseMapper}.
   *
   * @param firstName the first name of the tutor.
   * @param lastName the last name of the tutor.
   * @return a list of {@link CourseDTO} objects representing courses taught by the specified tutor.
   ...
   * {@link CourseRepository}. The result is mapped into a list of {@link CourseDTO} objects using
   * the {@link CourseMapper}.
   *
   * @param name the name of the course to search for.
   * @return a list of {@link CourseDTO} objects representing courses that match the given name. If
   ...
   * categoryName}. The result is mapped into a list of {@link CourseDTO} objects using the {@link
   * CourseMapper}.
   *
