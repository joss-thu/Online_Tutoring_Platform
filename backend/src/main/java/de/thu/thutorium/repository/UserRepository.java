...
public interface UserRepository extends JpaRepository<User, Long> {
     ...
     * string.
     */
    @Query("SELECT u FROM User u WHERE u.role = 'TUTOR' " + "AND (LOWER(CONCAT(u.firstName, ' ', u.lastName)) LIKE LOWER(CONCAT('%', :tutorName, '%')) " + "OR LOWER(CONCAT(u.lastName, ' ', u.firstName)) LIKE LOWER(CONCAT('%', :tutorName, '%')))")
