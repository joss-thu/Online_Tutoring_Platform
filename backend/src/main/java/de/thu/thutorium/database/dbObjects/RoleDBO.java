...
/**
 * Entity representing a role in the database. Contains details about the role, including its name
...
public class RoleDBO {
  ...
  /** Set of users associated with the role. Mapped by the roles attribute in the UserDBO entity. */
  ...
  public String toString() {
    return "RoleDBO {" + "role_id=" + role_id + ", role='" + roleName + '\'' + '}';
  }
}
